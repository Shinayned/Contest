...
public class Application {
    ...
    public Contest firstContest() {
        ...
        String contestDescription = "<b>Дата проведення:</b> двічі на рік - до 1 квітня та до 1 жовтня, про що не пізніше, ніж за три місяці повідомляються за підпорядкуванням наукові установи, організації і вищі навчальні заклади.<br>" +
                "<b>Хто може прийняти участь:</b> наукові працівники, науково-педагогічні працівники, аспіранти, ад’юнкти, докторанти, інші вчені та інженерно-технічні працівники наукових установ, організацій, вищих навчальних закладів.<br>" +
                "<b>Вік учасників:</b> не може перевищувати 33 років для осіб, які мають вищу освіту не нижче другого (магістерського) рівня, та 38 років для осіб, які мають науковий ступінь доктора наук або навчаються в докторантурі, на час їх висування для участі у конкурсі на здобуття стипендій.<br>";
        ...
        files.setTitle("Завантажити файл");
    ...
    public Contest secondContest() {
        ...
        String contestTitle = contestName;
        String contestDescription = "<b>Дата проведення:</b> двічі на рік (до 25 квітня і 25 жовтня)\n" +
                "<b>Хто може прийняти участь:</b> аспіранти, наукові працівники науково-дослідних інститутів та інших наукових установ, організацій, підприємств (обсерваторій, ботанічних садів, дендропарків, заповідників, бібліотек, музеїв) (далі - організації), що перебувають у віданні Національної академії наук.<br>" +
                "<b>Вік учасників:</    b> не більше 35 років для осіб, які мають вищу освіту не нижче другого (магістерського) рівня, та 40 років для осіб, які мають науковий ступінь доктора наук або навчаються в докторантурі, на час їх висування для участі у конкурсі на здобуття стипендій Президента України.<br>";
        String imgUrl = "/static/img/stipendium.png";
    ...
    public Contest thirdContest() {
        ...
        String contestTitle = contestName;
        String contestDescription = "<b>Дата проведення:</b> до 15 березня<br>" +
